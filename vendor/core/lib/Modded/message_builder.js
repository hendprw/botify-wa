...
try {
    ...
    console.warn('⚠️ [ourin-baileys] WARNING: Module "sharp" is not installed. Image resizing & processing may not work.\n👉 Please run: npm install sharp');
}

try {
    ffmpeg = (await import('fluent-ffmpeg')).default;
} catch {
    console.warn('⚠️ [ourin-baileys] WARNING: Module "fluent-ffmpeg" is not installed. Video previews may not work.\n👉 Please run: npm install fluent-ffmpeg');
}
